...
pub fn postgres_capabilities() -> HashSet<FeatureId> {
    ...
    features.insert(T176_SEQUENCE_GENERATOR);
    ...
    features.insert(T864_JSON_TABLE);
    ...
    features.insert(PG_RETURNING);
    features.insert(PG_SERIAL);
    features.insert(PG_ILIKE);
    features.insert(PG_DOUBLE_COLON_CAST);
    features.insert(PG_ARRAY_LITERALS);
    features.insert(PG_JSONB_TYPE);
    features.insert(PG_JSONB_OPERATORS);
