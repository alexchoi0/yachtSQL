...
fn test_create_or_replace_table() {
    ...
    let result = executor.execute_sql("SELECT * FROM replaceable").unwrap();
...
fn test_create_table_with_parameterized_string() {
    ...
    let result = executor.execute_sql("SELECT * FROM param_string").unwrap();
...
fn test_create_table_with_parameterized_bytes() {
    ...
    let result = executor.execute_sql("SELECT id FROM param_bytes").unwrap();
    assert_table_eq!(result, [[1]]);
}
...
fn test_create_table_ctas_preserves_types() {
    ...
    let result = executor.execute_sql("SELECT * FROM copy_types").unwrap();
...
fn test_create_table_like() {
    ...
    let result = executor.execute_sql("SELECT * FROM copy_schema").unwrap();
...
fn test_create_table_with_named_constraint() {
    ...
    let result = executor.execute_sql("SELECT * FROM child_table").unwrap();
...
fn test_create_table_with_multiple_foreign_keys() {
    ...
    let result = executor.execute_sql("SELECT name FROM products").unwrap();
...
fn test_create_table_with_column_reference() {
    ...
    let result = executor.execute_sql("SELECT * FROM ref_child").unwrap();
    assert_table_eq!(result, [[10, 1]]);
}
...
fn test_create_or_replace_table_clone() {
    ...
    let result = executor.execute_sql("SELECT * FROM clone_target").unwrap();
...
fn test_create_table_clone_for_system_time() {
    ...
    let result = executor.execute_sql("SELECT * FROM time_clone").unwrap();
...
fn test_create_table_clone_with_options() {
    ...
    let result = executor.execute_sql("SELECT id FROM opts_clone").unwrap();
    assert_table_eq!(result, [[1]]);
}
...
fn test_create_external_table() {
    ...
    let result = executor.execute_sql("SELECT * FROM external_data");
    assert!(result.is_ok());
}
...
fn test_create_table_like_with_options() {
    ...
    let result = executor.execute_sql("SELECT * FROM like_dest").unwrap();
    assert_table_eq!(result, [[1, "test", 1.5]]);
}
...
fn test_create_table_with_composite_foreign_key() {
    ...
    let result = executor.execute_sql("SELECT id FROM composite_fk").unwrap();
...
fn test_create_table_with_geography_type() {
    ...
    let result = executor.execute_sql("SELECT id FROM geo_table").unwrap();
    assert_table_eq!(result, [[1]]);
}
...
fn test_create_table_with_json_type() {
    ...
    let result = executor.execute_sql("SELECT id FROM json_table").unwrap();
    assert_table_eq!(result, [[1]]);
}
...
fn test_create_table_with_range_type() {
    ...
    let result = executor.execute_sql("SELECT id FROM range_table").unwrap();
    assert_table_eq!(result, [[1]]);
}
...
fn test_create_table_with_generate_uuid_default() {
    ...
    let result = executor.execute_sql("SELECT name FROM uuid_table").unwrap();
    assert_table_eq!(result, [["test"]]);
}
